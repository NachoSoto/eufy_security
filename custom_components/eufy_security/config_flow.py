        ...
        self.schema = vol.Schema(
            {
                ...
                vol.Optional(ConfigField.expose_stream_debug_attributes.name, default=self.config.expose_stream_debug_attributes): bool,
                vol.Optional(ConfigField.expose_debug_entities.name, default=self.config.expose_debug_entities): bool,
                vol.Optional(ConfigField.write_raw_video_debug_files.name, default=self.config.write_raw_video_debug_files): bool,
